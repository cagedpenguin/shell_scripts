...
# STATIC IP Example
# network --device eth0 --hostname kstest --bootproto=static --ip=0.0.0.0 --netmask=255.255.255.0 --gateway=0.0.0.0 --nameserver=8.8.8.8,8.8.4.4
network --device eth0 --hostname devlinux2 --bootproto=static --ip=0.0.0.0 --netmask=255.255.255.0 --gateway=0.0.0.0 --nameserver=8.8.8.8,8.8.4.4
